#if you're someone other than myself looking at this, apologies for the terribly written custom screens 😅
...
screen save():
    ...
    imagebutton:
        ...
        action ShowMenu('saveload')
        hovered [ShowMenu('saveload'), Hide('save')]
    ...
    use game_menu(_("Save/ Load"),):
        ...
        vbox:
            ...
            hbox:
                ...
                textbutton _("Save") action SetScreenVariable("files", "save")
                textbutton _("Load") action SetScreenVariable("files", "load")
        ...
        vbox:
            ...
            hbox:
                ...
                vbox:
                    style_prefix "check"
                    label _("Other")
                    textbutton _("Arrow Wiggle") action ToggleVariable("wiggle")
                    #textbutton _("Text Bleeps") action ToggleVariable("bleep")
    ...
    use game_menu(_("Help"), scroll="viewport"):
        ...
        vbox:
            ...
            hbox:
                ...
                textbutton _("Controls") action SetScreenVariable("device", "keyboard")
                textbutton _("Hints and Tips") action SetScreenVariable("device", "other")
...
screen keyboard_help():
    hbox:
        ...
        vbox:
            yalign 0.5
            text _("{color=#bcf6f0}Interacts with the object beneath the mouse.")
    ...
    hbox:
        ...
        vbox:
            yalign 0.5
            text _("{color=#bcf6f0}Opens the save/load screen and closes menus.")
    ...
    hbox:
        ...
        vbox:
            yalign 0.5
            text _("{color=#bcf6f0}Skips cutscenes.")
    ...
    hbox:
        ...
        vbox:
            yalign 0.5
            text _("{color=#bcf6f0}Skips dialogue while held down.")
    ...
    hbox:
        ...
        vbox:
            yalign 0.5
            text _("{color=#bcf6f0}Toggles dialogue skipping.")
    ...
    hbox:
        ...
        vbox:
            yalign 0.5
            text _("{color=#bcf6f0}Hides the user interface.")
    ...
    hbox:
        ...
        vbox:
            yalign 0.5
            text _("{color=#bcf6f0}Takes a screenshot.")
    ...
    hbox:
        ...
        vbox:
            yalign 0.5
            text _("{color=#bcf6f0}Turns on text-to-speech.")
    ...
    frame:
        ...
        hbox:
            ...
            vbox:
                ...
                text _("{color=#bcf6f0}{size=+10}If you're unsure of where to go, asking a companion might be able to help you (feature not in alpha). Alternatively, interacting with everything around you could create some interesting results.{/size}")
                text _("{color=#bcf6f0}{size=+10}\nInteracting with objects with different people in the room might net you different information, only investigation will tell how useful the information will be, however.")
            
            vbox:
                text _("{color=#bcf6f0}{size=+10}Put a tip 3 here. AA AAA AAAAAAAA AAAAAA AAAA AA")
                text _("{color=#bcf6f0}{size=+10}\nPut a tip 4 here. GG GGGGG GGGGG GGGGGGGG G")
                text _("{color=#bcf6f0}{size=+10}\nTHIS SCREEN IS UGLY :(")

screen mouse_help(): #ignore!
...
style help_label_text: #elephant
    size gui.text_size
    xalign 0.5
    text_align 0.0
...
transform buttup2:
    ...
    on idle:
        linear 0.6 xoffset 0 yoffset -5
        linear 0.6 xoffset 0 yoffset 0
        repeat
...
screen evidence():
    ...
    use game_menu(_("Evidence"), scroll="viewport"):
        ...
        vbox:
            ...
            hbox:
                ...
                textbutton _("Clues"):
                    action (
                        SetScreenVariable("page", "general"),
                        SetVariable("selection", 0)
                    )
                textbutton _("Chapter 1"):
                    action (
                        SensitiveIf(pp == True),
                        SetScreenVariable("page", "ch1"),
                        SetVariable("selection", 0)
                    )
                ...
                frame:
                    ...
                    viewport:
                        ...
                        vbox:
                            ...
                            if page == "general":
                                use main_evidence(clues)
                            elif page == "ch1":
                                use main_evidence(ch1murder)
                    
                vbox:
                    frame:
                        xsize 590
                        ysize 310
                        add "cluesgen_[selection].png" #(if general/ch1 etc. to make sure its the right group, like with the text)
                        ...
                        if page == "general":
                            viewport:
                                ...
                                vbox:
                                    spacing 5
                                    xpos 5
                                    for Cval,listo in enumerate(clues_text[selection]):

                                        $ write = clues_text[selection][Cval]

                                        text _("{color=#bcf6f0}[write]{/color}")
                            #$ write = clues_text[selection]
                            ...
                            vbox:
                                spacing 5
                                xpos 5
                                for Cval,listo in enumerate(ch1murder_text[selection]):

                                    $ write = ch1murder_text[selection][Cval]
    ...
    #either way thisll need a proper design doc i cant adlib this one its much too powerful id die in an instant

screen main_evidence(thelist): 
    #for TCval in range(len(clues)):
    #   textbutton _(clues[TCval]) action SetScreenVariable("selection", clues.get(TCval))

    for TCval,dicto in enumerate(thelist):

        textbutton _(thelist.get(dicto)):
            action (
                SetVariable("selection", dicto)
            )
...
screen mappy():
    use game_menu("Map"):
        ...
        if flagA == 1:
            ...
            $ strintloc = dmap1[currentlocation]
            $ bigx = strintloc[0:4]
            $ bigy = strintloc[4:8]
